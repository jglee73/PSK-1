										 ...
										 const CString& dsc_name)
{
	...
	MessageBox(NULL,
		msg,
		"CCommon_Error__DEF_VARIABLE::Call__ERROR__GET_DEF_DIGITAL_DESCRIPTION()",
								...
								const CString& def_var)
{
	...
	MessageBox(NULL,
		msg,
		"CCommon_Error__DEF_VARIABLE::Call__ERROR__GET_DEF_CONST_DATA()",
		MB_OK|MB_TOPMOST|MB_ICONERROR);
	return 1;
}
								   ...
								   const CString& var_name)
{
	...
	MessageBox(NULL,
		msg,
		"CCommon_Error__DEF_VARIABLE::Call__ERROR__GET_CHANNEL_TYPE_CTRL()",
		MB_OK|MB_TOPMOST|MB_ICONERROR);
	return 1;
}
