...
// ...
CObj__SINGLE_ARM_STD::CObj__SINGLE_ARM_STD()
{
	iLPx_SIZE = -1;
}
CObj__SINGLE_ARM_STD::~CObj__SINGLE_ARM_STD()
...
// ...
int CObj__SINGLE_ARM_STD::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	// ...
	{
		sObject_Name = obj;
...
int CObj__SINGLE_ARM_STD::__DEFINE__VERSION_HISTORY(version)
{
	version += "JG.Lee \n";
...
int CObj__SINGLE_ARM_STD::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// ...
	{
		...
		STD__ADD_DIGITAL_WITH_X_OPTION(str_name, "SINGLE","");
...
int CObj__SINGLE_ARM_STD::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
int CObj__SINGLE_ARM_STD::__Define__USER_FUNCTION(CII_DEFINE__FUNCTION *p_fnc_ctrl)
{
...
//-------------------------------------------------------------------------
int CObj__SINGLE_ARM_STD::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	// mMacro_Log.Init_LOG();
	...
	// OBJ : ATM_ROBOT ...
	{
		...
		LINK__EXT_VAR_STRING_CTRL(xCH__ATM_RB__TARGET_LLx_NAME_SET, db_name, "TARGET.LLx.NAME.SET");
		LINK__EXT_VAR_STRING_CTRL(xCH__ATM_RB__TARGET_LLx_SLOT_SET, db_name, "TARGET.LLx.SLOT.SET");
...
//-------------------------------------------------------------------------
int CObj__SINGLE_ARM_STD::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
...
int CObj__SINGLE_ARM_STD::__CALL__MONITORING(id,p_variable,p_alarm)
{
	switch(id)
	{
