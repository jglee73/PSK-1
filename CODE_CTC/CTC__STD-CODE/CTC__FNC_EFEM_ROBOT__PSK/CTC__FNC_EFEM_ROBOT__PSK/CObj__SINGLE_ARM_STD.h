...
#include "CObj__SINGLE_ARM_STD__ALID.h"
#include "CObj__SINGLE_ARM_STD__DEF.h"


class CObj__SINGLE_ARM_STD : public __IOBJ__STD_TYPE
{
private:
	//-------------------------------------------------------------------------
	...
	CX__VAR_STRING_CTRL  xCH__ATM_RB__TARGET_LLx_NAME_SET;
	CX__VAR_STRING_CTRL  xCH__ATM_RB__TARGET_LLx_SLOT_SET;
