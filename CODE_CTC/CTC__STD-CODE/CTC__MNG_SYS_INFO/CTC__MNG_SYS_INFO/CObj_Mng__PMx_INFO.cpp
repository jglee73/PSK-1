...
//-------------------------------------------------------------------------
CObj_Mng__PMx_INFO::CObj_Mng__PMx_INFO()
{
...
//-------------------------------------------------------------------------
int CObj_Mng__PMx_INFO::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
...
int CObj_Mng__PMx_INFO::__DEFINE__VERSION_HISTORY(version)
{
...
int CObj_Mng__PMx_INFO::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// RF ITEM ...
	{
		str_name = "PMC_PART.RF.AC_CONTACTOR_SET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_RF_AC_CONTACTOR_SET, str_name);
		
		str_name = "PMC_PART.RF.AC_CONTACTOR_GET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_RF_AC_CONTACTOR_GET, str_name);
	}
	...
	for(i=0;i<CFG__RF_SIZE;i++)
	{
		...
		str_name.Format("PMC_PART.MAT.%s_ON_STATUS", part_name);
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_MATx_ON_STATUS[i], str_name);

		str_name.Format("PMC_PART.MAT.%s_TUNE_STATUS", part_name);
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_MATx_TUNE_STATUS[i], str_name);
		
		str_name.Format("PMC_PART.MAT.%s_CONTROL_MODE", part_name);
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_MATx_CONTROL_MODE[i], str_name);

		str_name.Format("PMC_PART.MAT.%s_CUR_LOAD_POS", part_name);
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_MATx_CUR_LOAD_POS[i], str_name);

		str_name.Format("PMC_PART.MAT.%s_CUR_TUNE_POS", part_name);
		STD__ADD_STRING(str_name);
	...
	// WAP ITEM ...
	{
		str_name = "PMC_PART.WAP.POSITION_SET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_WAP_POSITION_SET, str_name);

		str_name = "PMC_PART.WAP.POSITION_GET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_WAP_POSITION_GET, str_name);
	
		str_name = "PMC_PART.WAP.PRESSURE_SET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_WAP_PRESSURE_SET, str_name);

		str_name = "PMC_PART.WAP.PRESSURE_GET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_WAP_PRESSURE_GET, str_name);
	}

	// TEMPERATURE ITEM ...
	{
		str_name = "PMC_PART.TOP_CHILLER.TEMP_SET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_TOP_CHILLER_TEMP_SET, str_name);

		str_name = "PMC_PART.TOP_CHILLER.TEMP_GET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_TOP_CHILLER_TEMP_GET, str_name);

		str_name = "PMC_PART.ESC.TEMP_SET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_ESC_TEMP_SET, str_name);

		str_name = "PMC_PART.ESC.TEMP_GET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_ESC_TEMP_GET, str_name);

		str_name = "PMC_PART.TOP_PLATE.TEMP_SET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_TOP_PLATE_TEMP_SET, str_name);

		str_name = "PMC_PART.TOP_PLATE.TEMP_GET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_TOP_PLATE_TEMP_GET, str_name);

		str_name = "PMC_PART.ANAFAZER.TOP_TEMP_GET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_ANAFAZER_TOP_TEMP_GET, str_name);

		str_name = "PMC_PART.ANAFAZER.TOP_BOTTOM_GET";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__PMC_PART_ANAFAZER_TOP_BOTTOM_GET, str_name);
	}
...
int CObj_Mng__PMx_INFO::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
int CObj_Mng__PMx_INFO::__Define__USER_FUNCTION(CII_DEFINE__FUNCTION *p_fnc_ctrl)
{
...
//-------------------------------------------------------------------------
int CObj_Mng__PMx_INFO::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	CString ch_name;
	...
	// DB OBJ -----
	{
		...
		for(i=0;i<iPMC_SIZE;i++)
		{
			...
			LINK__EXT_VAR_DIGITAL_CTRL(xEXT_CH__PMx_USE_FLAG[i], def_data,var_name);
		}
	}
	...
	for(k=0;k<iPMC_SIZE;k++)
	{
		...
		// RF ITEM ...
		{
			//
			{
				def_name.Format("%1d.CH.RF.AC_CONTACTOR_SET", chm_id);
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);

				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
				LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_RF_AC_CONTACTOR_SET[k], obj_name,var_name);
			}

			//
			{
				def_name.Format("%1d.CH.RF.AC_CONTACTOR_GET", chm_id);
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);

				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
				LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_RF_AC_CONTACTOR_GET[k], obj_name,var_name);
			}
		...
		// MATCHER ITEM ...
		{
			...
			for(i=0;i<CFG__RF_SIZE;i++)
			{
				...
				//
				def_name.Format("%1d.CH.MAT.RF%1d.ON_STATUS", chm_id,rf_id);
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
				...
				//
				def_name.Format("%1d.CH.MAT.RF%1d.TUNE_STATUS", chm_id,rf_id);
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
				...
				//
				def_name.Format("%1d.CH.MAT.RF%1d.CONTROL_MODE", chm_id,rf_id);
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
				...
				//
				def_name.Format("%1d.CH.MAT.RF%1d.CUR_LOAD_POS", chm_id,rf_id);
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
				...
				//
				def_name.Format("%1d.CH.MAT.RF%1d.CUR_TUNE_POS", chm_id,rf_id);
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
		...
		{
			//
			def_name.Format("%1d.CH.WAP.POSITION_SET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
			
			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_WAP_POSITION_SET[k], obj_name,var_name);
			
			//
			def_name.Format("%1d.CH.WAP.POSITION_GET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_WAP_POSITION_GET[k], obj_name,var_name);
	
			//
			def_name.Format("%1d.CH.WAP.PRESSURE_SET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_WAP_PRESSURE_SET[k], obj_name,var_name);

			//
			def_name.Format("%1d.CH.WAP.PRESSURE_GET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_WAP_PRESSURE_GET[k], obj_name,var_name);
		}

		// TEMPERATURE ITEM ...
		{
			//
			def_name.Format("%1d.CH.TOP_CHILLER.TEMP_SET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_TOP_CHILLER_TEMP_SET[k], obj_name,var_name);

			//
			def_name.Format("%1d.CH.TOP_CHILLER.TEMP_GET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_TOP_CHILLER_TEMP_GET[k], obj_name,var_name);

			//
			def_name.Format("%1d.CH.ESC.TEMP_SET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_ESC_TEMP_SET[k], obj_name,var_name);

			//
			def_name.Format("%1d.CH.ESC.TEMP_GET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_ESC_TEMP_GET[k], obj_name,var_name);

			//
			def_name.Format("%1d.CH.TOP_PLATE.TEMP_SET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_TOP_PLATE_TEMP_SET[k], obj_name,var_name);

			//
			def_name.Format("%1d.CH.TOP_PLATE.TEMP_GET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_TOP_PLATE_TEMP_GET[k], obj_name,var_name);

			//
			def_name.Format("%1d.CH.ANAFAZER.TOP_TEMP_GET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_ANAFAZER_TOP_TEMP_GET[k], obj_name,var_name);

			//
			def_name.Format("%1d.CH.ANAFAZER.TOP_BOTTOM_GET", chm_id);
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);

			LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PMC_PART_ANAFAZER_TOP_BOTTOM_GET[k], obj_name,var_name);
		}
...
//-------------------------------------------------------------------------
int CObj_Mng__PMx_INFO::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	int flag = -1;
...
int CObj_Mng__PMx_INFO::__CALL__MONITORING(id,p_variable,p_alarm)
{
	switch(id)
	{
