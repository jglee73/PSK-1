...
//-------------------------------------------------------------------------
CObj_Mng__SIGNAL_TOWER_STD::CObj_Mng__SIGNAL_TOWER_STD()
{
...
//-------------------------------------------------------------------------
int CObj_Mng__SIGNAL_TOWER_STD::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;

	return 1;
}
int CObj_Mng__SIGNAL_TOWER_STD::__DEFINE__VERSION_HISTORY(version)
{
	return 1;
}
...
int CObj_Mng__SIGNAL_TOWER_STD::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj_Mng__SIGNAL_TOWER_STD::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;

	// ...
	CString title;
	title.Format("%s [CObj_Mng__SIGNAL_TOWER_STD] : ",sObject_Name);
...
//-------------------------------------------------------------------------
int CObj_Mng__SIGNAL_TOWER_STD::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
...
//-------------------------------------------------------------------------
int CObj_Mng__SIGNAL_TOWER_STD::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	int flag = -1;
...
int CObj_Mng__SIGNAL_TOWER_STD::__CALL__MONITORING(id,p_variable,p_alarm)
{
	switch(id)
	{
