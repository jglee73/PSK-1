...
extern int  Macro__Get_Para_List_From_String(const CString& str_data,
											 CStringArray& l_para);

extern void Macro__Load_StringArray(CStringArray& l_db_array,
									const CStringArray& l_src_array);

extern int  Macro__Analyze_Title_Info(const CString& title,
									  int& wfr_ptn,
									  int& wfr_slot);
