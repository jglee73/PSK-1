...
::Register__ERROR__EXT_FNC_VAR(const CString& var_name)
{
	...
	//
	CString title;
	title.Format("%s - CCommon_Error__USER_FNC::Register__ERROR__EXT_FNC_VAR()",sObj_Name);
...
::Register__ERROR__EXT_RET_INT(const CString& fnc_name)
{
	...
	//
	CString title;
	title.Format("%s - CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_INT()",sObj_Name);
...
::Register__ERROR__EXT_RET_DOUBLE(const CString& fnc_name)
{
	...
	//
	CString title;
	title.Format("%s - CCommon_Error__USER_FNC::Register__ERROR__EXT_FNC_DOUBLE()",sObj_Name);
...
::Register__ERROR__EXT_RET_STRING(const CString& fnc_name)
{
	...
	//
	CString title;
	title.Format("%s - CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_STRING()",sObj_Name);
...
::Register__ERROR__EXT_RET_CONDITION(const CString& fnc_name)
{
	...
	//
	CString title;
	title.Format("%s - CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_CONDITION()",sObj_Name);
...
::Register__ERROR__EXT_RET_INT__INT_STRING(const CString& fnc_name)
{
	...
	//
	CString title;
	title.Format("%s - CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_INT__INT_STRING()",sObj_Name);
...
::Register__ERROR__EXT_RET_INT__STRING_STRING(const CString& fnc_name)
{
	...
	//
	CString title;
	title.Format("%s - CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_INT__STRING_STRING()",sObj_Name);
...
::Register__ERROR__EXT_RET_STRING__INT(const CString& fnc_name)
{
	...
	//
	CString title;
	title.Format("%s - CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_STRING__INT()",sObj_Name);
...
::Register__ERROR__EXT_RET_STRING__STRING(const CString& fnc_name)
{
	...
	//
	CString title;
	title.Format("%s - CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_STRING__STRING()",sObj_Name);
