...
public:
	...
	// ...
	int Call__ERROR__GET_DEF_DIGITAL_DESCRIPTION(const CString& obj_name,
												 const CString& dsc_name);

	int Call__ERROR__GET_DEF_CONST_DATA(const CString& obj_name,
										const CString& def_var);

	int Call__ERROR__GET_CHANNEL_TYPE_CTRL(const CString& ch_type,
