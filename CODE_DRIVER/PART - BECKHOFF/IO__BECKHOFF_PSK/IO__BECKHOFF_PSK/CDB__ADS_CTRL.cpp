...
void CDB__ADS_CTRL::Load__ADS_IN_INFO(const CString& ads_name, const int data_size,const CString& data_type)
{
	EnterCriticalSection(&mDB_LOCK);

	mDB__ADS_IN.Load__ADS_INFO(ads_name, data_size,data_type);
...
int  CDB__ADS_CTRL::Load__ADS_OUT_INFO(const CString& ads_name, const int data_size,const CString& data_type)
{
	EnterCriticalSection(&mDB_LOCK);

	int r_flag = mDB__ADS_OUT.Load__ADS_INFO(ads_name, data_size,data_type);
