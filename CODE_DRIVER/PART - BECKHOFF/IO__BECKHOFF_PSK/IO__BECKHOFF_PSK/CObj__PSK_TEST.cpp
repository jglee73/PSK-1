...
int CObj__PSK_TEST::__DEFINE__CONTROL_MODE(obj, l_mode)
{
	...
	// ...
	{
		...
		ADD__CTRL_VAR(sMODE__ADS_INIT_DRIVER,    "ADS.INIT_DRIVER");
...
int CObj__PSK_TEST::__CALL__CONTROL_MODE(mode, p_debug, p_variable, p_alarm)
{
	...
	// ...
	{
		...
		ELSE_IF__CTRL_MODE(sMODE__ADS_INIT_DRIVER)			flag = Call__ADS_INIT_DRIVER(p_variable,p_alarm);
