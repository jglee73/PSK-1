...
//--------------------------------------------------------------------------------
int CObj__LOT_NET::__DEFINE__CONTROL_MODE(obj, l_mode)
{
	sObject_Name = obj;
...
int CObj__LOT_NET::__DEFINE__VERSION_HISTORY(version)
{
	version = "By JG Lee \n";
...
int CObj__LOT_NET::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__LOT_NET::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
int CObj__LOT_NET::__DEFINE__VARIABLE_IO(p_io_variable)
{
...
//--------------------------------------------------------------------------------
int CObj__LOT_NET::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString file_name;
	CString log_msg;
...
::__INITIALIZE__IO(p_io_para)
{
	...
	// ...
	{
		...
		str_info = "Terminal String : Out <CR>, In <CR><LF>";
	...
	mX_Net->SET__TERMINAL_OutSTRING(out_end, 1);
	mX_Net->SET__TERMINAL_InSTRING(in_end, 2);
...
//--------------------------------------------------------------------------------
int CObj__LOT_NET::__CALL__CONTROL_MODE(mode, p_debug, p_variable, p_alarm)
{
	int flag = -1;	
...
int CObj__LOT_NET::__CALL__MONITORING(id, p_variable, p_alarm)
{
	switch(id)
	{
