...
int CObj__LAMP_CTRL::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// REMOTE_LINK...
	{
		// LIGHT.ON_OFF.ACTIVE ...
		{
			str_name = "LINK.LIGHT.RED.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_RED_ON_OFF_ACTIVE, str_name);

			str_name = "LINK.LIGHT.YELLOW.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_YELLOW_ON_OFF_ACTIVE, str_name);

			str_name = "LINK.LIGHT.GREEN.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_GREEN_ON_OFF_ACTIVE, str_name);

			str_name = "LINK.LIGHT.BLUE.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_BLUE_ON_OFF_ACTIVE, str_name);

			str_name = "LINK.LIGHT.WHITE.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_WHITE_ON_OFF_ACTIVE, str_name);
		}
		// LIGHT.BLINK.ACTIVE ...
		{
			str_name = "LINK.LIGHT.RED.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_RED_BLINK_ACTIVE, str_name);

			str_name = "LINK.LIGHT.YELLOW.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_YELLOW_BLINK_ACTIVE, str_name);

			str_name = "LINK.LIGHT.GREEN.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_GREEN_BLINK_ACTIVE, str_name);

			str_name = "LINK.LIGHT.BLUE.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_BLUE_BLINK_ACTIVE, str_name);

			str_name = "LINK.LIGHT.WHITE.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name,APP_DSP__OFF_ON,"");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_LIGHT_WHITE_BLINK_ACTIVE, str_name);
		}

		// ALARM & MELODY ...
		{
			str_name = "LINK.ALARM.BUZZER";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_ALARM_BUZZER, str_name);

			str_name = "LINK.MELODY.BUZZER";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LINK_MELODY_BUZZER, str_name);
		}
	}
	...
	// LOCAL_LINK ...
	{
		// LIGHT.ON_OFF.ACTIVE ...
		{
			str_name = "LOCAL_LINK.LIGHT.RED.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_RED_ON_OFF_ACTIVE, str_name);

			str_name = "LOCAL_LINK.LIGHT.YELLOW.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_YELLOW_ON_OFF_ACTIVE, str_name);

			str_name = "LOCAL_LINK.LIGHT.GREEN.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_GREEN_ON_OFF_ACTIVE, str_name);

			str_name = "LOCAL_LINK.LIGHT.BLUE.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_BLUE_ON_OFF_ACTIVE, str_name);

			str_name = "LOCAL_LINK.LIGHT.WHITE.ON_OFF.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_WHITE_ON_OFF_ACTIVE, str_name);
		}
		// LIGHT.BLINK.ACTIVE ...
		{
			str_name = "LOCAL_LINK.LIGHT.RED.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_RED_BLINK_ACTIVE, str_name);

			str_name = "LOCAL_LINK.LIGHT.YELLOW.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_YELLOW_BLINK_ACTIVE, str_name);

			str_name = "LOCAL_LINK.LIGHT.GREEN.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_GREEN_BLINK_ACTIVE, str_name);

			str_name = "LOCAL_LINK.LIGHT.BLUE.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_BLUE_BLINK_ACTIVE, str_name);

			str_name = "LOCAL_LINK.LIGHT.WHITE.BLINK.ACTIVE";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_LIGHT_WHITE_BLINK_ACTIVE, str_name);
		}

		// ALARM & MELODY ...
		{
			str_name = "LOCAL_LINK.ALARM.BUZZER";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_ALARM_BUZZER, str_name);

			str_name = "LOCAL_LINK.MELODY.BUZZER";
			STD__ADD_DIGITAL_WITH_COMMENT(str_name, APP_DSP__OFF_ON, "");
			LINK__VAR_DIGITAL_CTRL(dCH__LOCAL_LINK_MELODY_BUZZER, str_name);
		}
	}
