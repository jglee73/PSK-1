...
::Register__ERROR__EXT_FNC_MODE(const CString& mode_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_FNC_MODE()";

	msg.Format("Obj_Name  : %s \n", sObj_Name);
	bff.Format("Mode Name : %s \n", mode_name);
	msg += bff;
...
::Register__ERROR__EXT_FNC_VAR(const CString& var_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_FNC_VAR()";

	msg.Format("Obj_Name  : %s \n", sObj_Name);
	bff.Format("Var_Name  : %s \n", var_name);
	msg += bff;
...
::Register__ERROR__EXT_RET_INT(const CString& fnc_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_INT()";
...
::Register__ERROR__EXT_RET_DOUBLE(const CString& fnc_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_DOUBLE()";
...
::Register__ERROR__EXT_RET_STRING(const CString& fnc_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_STRING()";
...
::Register__ERROR__EXT_RET_CONDITION(const CString& fnc_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_CONDITION()";
...
::Register__ERROR__EXT_RET_INT__INT_STRING(const CString& fnc_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_INT__INT_STRING()";
...
::Register__ERROR__EXT_RET_INT__STRING_STRING(const CString& fnc_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_INT__STRING_STRING()";
...
::Register__ERROR__EXT_RET_STRING__INT(const CString& fnc_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_STRING__INT()";
...
::Register__ERROR__EXT_RET_STRING__STRING(const CString& fnc_name)
{
	...
	title = "CCommon_Error__USER_FNC::Register__ERROR__EXT_RET_STRING__STRING()";
