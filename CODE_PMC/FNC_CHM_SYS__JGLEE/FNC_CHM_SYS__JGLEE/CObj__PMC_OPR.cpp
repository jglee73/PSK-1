...
int CObj__PMC_OPR::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	...
	// ...
	{
		...
		ELSE_IF__CTRL_MODE(sMODE__SLOT_OPEN)
		{
			flag = Call__SLOT_OPEN(p_variable);
		}
		ELSE_IF__CTRL_MODE(sMODE__SLOT_CLOSE)
		{
			flag = Call__SLOT_CLOSE(p_variable);
		}
		ELSE_IF__CTRL_MODE(sMODE__PIN_UP)
		{
			flag = Call__PIN_UP(p_variable);
		}
		ELSE_IF__CTRL_MODE(sMODE__PIN_DOWN)
		{
			flag = Call__PIN_DOWN(p_variable);
		}
