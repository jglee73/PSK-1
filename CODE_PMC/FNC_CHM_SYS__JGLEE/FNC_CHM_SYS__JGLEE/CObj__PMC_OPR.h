...
private:
	...
	CX__VAR_STRING_CTRL  sEXT_CH__MON_INTERLOCK_HEAVY_MSG_GAS_BOX;

	CX__VAR_DIGITAL_CTRL dEXT_CH__MON_INTERLOCK_HEAVY_ACTIVE_CHAMBER;
	CX__VAR_STRING_CTRL  sEXT_CH__MON_INTERLOCK_HEAVY_MSG_CHAMBER;

	CX__VAR_DIGITAL_CTRL dEXT_CH__MON_INTERLOCK_HEAVY_ACTIVE_RF_SYS;
	CX__VAR_STRING_CTRL  sEXT_CH__MON_INTERLOCK_HEAVY_MSG_RF_SYS;

	// CFG : SYSTEM_INITIAL ...
	CX__VAR_DIGITAL_CTRL dEXT_CH__CFG_SYSTEM_INITIAL_DI_SENSOR_INTERLOCK_CHECK;
	CX__VAR_DIGITAL_CTRL dEXT_CH__CFG_SYSTEM_INITIAL_AUTO_PM_CHECK;

	// CFG : WAFER_COUNT
	CX__VAR_DIGITAL_CTRL dEXT_CH__CFG_WAFER_COUNT_WARNING_APPLY;
	CX__VAR_ANALOG_CTRL  aEXT_CH__CFG_WAFER_COUNT_WARNING_REF;

	CX__VAR_DIGITAL_CTRL dEXT_CH__CFG_WAFER_COUNT_SYSTEM_DOWN_APPLY;
	CX__VAR_ANALOG_CTRL  aEXT_CH__CFG_WAFER_COUNT_SYSTEM_DOWN_REF;
	...
	// CH LINK ...
	CX__VAR_ANALOG_CTRL  aEXT_CH__TOTAL_WAFER_COUNT;
	//
