...
private:
	...
	// OBJ MAT_SOURCE ...
	int MAT_SRC_OBJ__Start_MODE(const CString& obj_mode);
	int MAT_SRC_OBJ__Check_ABORTED();

	bool bActive__OBJ_CTRL__MAT_SRC;
	CII_EXT_OBJECT__CTRL *pOBJ_CTRL__MAT_SRC;

	CX__VAR_ANALOG_CTRL  aEXT_CH__MAT_SRC__PARA_LOAD_POS_CH1;
	CX__VAR_ANALOG_CTRL  aEXT_CH__MAT_SRC__PARA_TUNE_POS_CH1;
	CX__VAR_ANALOG_CTRL  aEXT_CH__MAT_SRC__PARA_CAP_POS_CH1;

	// OBJ MAT_BIAS ...
	int MAT_BIAS_OBJ__Start_MODE(const CString& obj_mode);
	int MAT_BIAS_OBJ__Check_ABORTED();

	bool bActive__OBJ_CTRL__MAT_BIAS;
	CII_EXT_OBJECT__CTRL *pOBJ_CTRL__MAT_BIAS;

	CX__VAR_ANALOG_CTRL  aEXT_CH__MAT_BIAS__PARA_LOAD_POS_CH1;
	CX__VAR_ANALOG_CTRL  aEXT_CH__MAT_BIAS__PARA_TUNE_POS_CH1;
	CX__VAR_ANALOG_CTRL  aEXT_CH__MAT_BIAS__PARA_CAP_POS_CH1;
