...
//----------------------------------------------------------
#define CLS__STEP_METAL					"STEP.METAL"
#define CLS__STEP_STRIP					"STEP.STRIP"


DECLARE_START__DLL_STD_OBJ__GET_CLASS_LIST

ADD__OBJ_CLS(CLS__STEP_METAL);
ADD__OBJ_CLS(CLS__STEP_STRIP);
...
IF__OBJ_CLS(CLS__STEP_METAL)			return (new CObj__STEP_METAL);
IF__OBJ_CLS(CLS__STEP_STRIP)			return (new CObj__STEP_STRIP);
