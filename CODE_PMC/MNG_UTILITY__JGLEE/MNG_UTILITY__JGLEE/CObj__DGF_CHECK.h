...
private:
	...
	// NEW LIST
	CX__VAR_STRING_CTRL  sCH_PARA__NEW_RESULT_mTORR_LIST[CFG__TEST_LIST];
	CX__VAR_STRING_CTRL  sCH_PARA__NEW_RESULT_START_mTORR_LIST[CFG__TEST_LIST];
	CX__VAR_STRING_CTRL  sCH_PARA__NEW_RESULT_END_mTORR_LIST[CFG__TEST_LIST];

	// DELTA LIST
	CX__VAR_STRING_CTRL  sCH_PARA__DELTA_RESULT_mTORR_LIST[CFG__TEST_LIST];
	CX__VAR_STRING_CTRL  sCH_PARA__DELTA_RESULT_PER_LIST[CFG__TEST_LIST];

	// CHECK TIME COUNT
	CX__VAR_STRING_CTRL  sCH_PARA__CHECK_TIME_COUNT;

	CX__VAR_STRING_CTRL  sCH_RESULT__START_PRESSURE_mTORR;
	CX__VAR_STRING_CTRL  sCH_RESULT__END_PRESSURE_mTORR;
	...
	CX__VAR_ANALOG_CTRL  aCH_CFG__BASELINE_mTORR[CFG__TEST_LIST];
	...
	CString sMODE__COPY_NEW_TO_BASELINE;
	int  Call__COPY_NEW_TO_BASELINE(CII_OBJECT__VARIABLE *p_variable,CII_OBJECT__ALARM *p_alarm);
