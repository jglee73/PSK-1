========================================================================
    MFC 라이브러리 : PMC__PHY_MFC 프로젝트 개요
========================================================================


응용 프로그램 마법사에서 이 PMC__PHY_MFC DLL을 만들었습니다.  이 DLL은
MFC의 기본 사용법을 보여 줄 뿐만 아니라 DLL을 작성하기 위한 기본 구조를 제공합니다.

이 파일에는 PMC__PHY_MFC DLL을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
PMC__PHY_MFC.h
    해당 DLL의 기본 헤더 파일이며,  CPMC__PHY_MFCApp
    클래스가 선언되어 있습니다.

PMC__PHY_MFC.cpp
    기본 DLL 소스 파일입니다.  CPMC__PHY_MFCApp 클래스가 포함되어 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 PMC__PHY_MFC.pch와
