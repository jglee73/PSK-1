...
#include "CObj__CHM_PSK_IO__ALID.h"


//-------------------------------------------------------------------------
CObj__CHM_PSK_IO::CObj__CHM_PSK_IO()
{
...
//-------------------------------------------------------------------------
int CObj__CHM_PSK_IO::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
...
int CObj__CHM_PSK_IO::__DEFINE__VERSION_HISTORY(version)
{
...
int CObj__CHM_PSK_IO::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__CHM_PSK_IO::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
//-------------------------------------------------------------------------
int CObj__CHM_PSK_IO::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{	
	// ...
	{
		CString file_name;
	...
	// LINK : State Channel
	{
		...
		def_name = "CH__PLASMA_RF_POWER";
		p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
		p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
		LINK__EXT_VAR_ANALOG_CTRL(aEXT_CH__PLASMA_RF_POWER, obj_name,var_name);
...
//-------------------------------------------------------------------------
int CObj__CHM_PSK_IO::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	int flag = -1;
...
int CObj__CHM_PSK_IO::__CALL__MONITORING(id,p_variable,p_alarm)
{
