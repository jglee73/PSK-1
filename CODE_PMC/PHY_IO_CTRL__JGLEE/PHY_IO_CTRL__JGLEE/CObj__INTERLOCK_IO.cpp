...
//-------------------------------------------------------------------------
CObj__INTERLOCK_IO::CObj__INTERLOCK_IO()
{
...
//-------------------------------------------------------------------------
int CObj__INTERLOCK_IO::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;

	return 1;
}
int CObj__INTERLOCK_IO::__DEFINE__VERSION_HISTORY(version)
{
...
int CObj__INTERLOCK_IO::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__INTERLOCK_IO::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
//-------------------------------------------------------------------------
int CObj__INTERLOCK_IO::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{	
	// ...
	{
		CString file_name;
...
//-------------------------------------------------------------------------
int CObj__INTERLOCK_IO::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	int flag = -1;
...
int CObj__INTERLOCK_IO::__CALL__MONITORING(id,p_variable,p_alarm)
{
