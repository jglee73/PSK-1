...
private:
	...
	CX__VAR_ANALOG_CTRL  aEXT_CH__AI_ESC_VOLTAGE;

	//
	CX__VAR_DIGITAL_CTRL dEXT_CH__DO_PIN_UP;
	CX__VAR_DIGITAL_CTRL dEXT_CH__DO_PIN_DOWN;
	CX__VAR_DIGITAL_CTRL dEXT_CH__DO_PIN_MIDDLE;
	...
	int Call__MIDDLE(CII_OBJECT__VARIABLE *p_variable, CII_OBJECT__ALARM *p_alarm);
