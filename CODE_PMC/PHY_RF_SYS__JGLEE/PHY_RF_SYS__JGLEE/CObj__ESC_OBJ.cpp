...
//-------------------------------------------------------------------------
int CObj__ESC_OBJ::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
...
int CObj__ESC_OBJ::__DEFINE__VERSION_HISTORY(version)
{
...
//-------------------------------------------------------------------------
int CObj__ESC_OBJ::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	...
	// ESC_POWER : CENTER & EDGE  ...
	{
		// CENTER.USE ...
		{
			def_name = "ESC_POWER.CENTER_USE";
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, def_data);

			def_check = x_utility.Check__Link(def_data);
			bActive__ESC_POWER_CENTER_USE = def_check;
		}
		// EDGE.USE ...
		{
			def_name = "ESC_POWER.EDGE_USE";
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, def_data);

			def_check = x_utility.Check__Link(def_data);
			bActive__ESC_POWER_EDGE_USE = def_check;
		}
	}
	// HE_CONTROL : CENTER & EDGE  ...
	{
		// CENTER.USE ...
		{
			def_name = "HE_CONTROL.CENTER_USE";
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, def_data);

			def_check = x_utility.Check__Link(def_data);
			bActive__HE_CONTROL_CENTER_USE = def_check;
		}
		// EDGE.USE ...
		{
			def_name = "HE_CONTROL.EDGE_USE";
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, def_data);

			def_check = x_utility.Check__Link(def_data);
			bActive__HE_CONTROL_EDGE_USE = def_check;
		}
	}

	// ESC_POWER & IO Channel ...
	{
		// LINK_OBJ.ESC_POWER ...
		{
			def_name = "LINK_OBJ.ESC_POWER";
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, obj_name);

			pOBJ_CTRL__ESC_POWER = p_ext_obj_create->Create__OBJECT_CTRL(obj_name);
	...
	// HE VALVE & PRESSURE Channel ...
	{
		// LINK_OBJ.HE_VALVE ...
		{
			def_name = "LINK_OBJ.HE_VALVE";
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name, obj_name);

			pOBJ_CTRL__HE_VALVE = p_ext_obj_create->Create__OBJECT_CTRL(obj_name);
		}
		// LINK_DO.HE_VALVE ...
		{
			// ...
			{
				def_name = "LINK_DO.HE_SUPPLY_VLV";
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
				LINK__EXT_VAR_DIGITAL_CTRL(doEXT_CH__HE_VALVE_SUPPLY, obj_name,var_name);			
			}

			if(bActive__HE_CONTROL_CENTER_USE)
			{
				def_name = "LINK_DO.HE_FINAL_OUT_VLV.CENTER";
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
				LINK__EXT_VAR_DIGITAL_CTRL(doEXT_CH__HE_VALVE_FINAL_OUT_CENTER, obj_name,var_name);			
			}
			if(bActive__HE_CONTROL_EDGE_USE)
			{
				def_name = "LINK_DO.HE_FINAL_OUT_VLV.EDGE";
				p_ext_obj_create->Get__DEF_CONST_DATA(def_name, ch_name);
				p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(ch_name, obj_name,var_name);
				LINK__EXT_VAR_DIGITAL_CTRL(doEXT_CH__HE_VALVE_FINAL_OUT_EDGE, obj_name,var_name);			
			}
		}
...
int CObj__ESC_OBJ::__CALL__MONITORING(id,p_variable,p_alarm)
{
	switch(id)
	{
