...
#include "CObj__ESC_OBJ__ALID.h"
#include "CObj__ESC_OBJ__DEF.h"



class CObj__ESC_OBJ : public __IOBJ__STD_TYPE
{
private:
	//-------------------------------------------------------------------------
	...
	*/
	...
	bool bActive__ESC_POWER_EDGE_USE;

	// LINK_OBJ.ESC_POWER ...
	CII_EXT_OBJECT__CTRL *pOBJ_CTRL__ESC_POWER;
	...
	bool bActive__HE_CONTROL_CENTER_USE;
	bool bActive__HE_CONTROL_EDGE_USE;

	// LINK_OBJ.HE_VALVE ...
	CII_EXT_OBJECT__CTRL *pOBJ_CTRL__HE_VALVE;

	CX__VAR_DIGITAL_CTRL doEXT_CH__HE_VALVE_SUPPLY;

	CX__VAR_DIGITAL_CTRL doEXT_CH__HE_VALVE_FINAL_OUT_CENTER;
	CX__VAR_DIGITAL_CTRL doEXT_CH__HE_VALVE_FINAL_OUT_EDGE;
	...
	int  Call__DECHUCK(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm, const int dechuck_mode);

	int  Fnc__DECHUCK(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm, 	const int dechuck_mode);
	int  Fnc__ESC_ABORT(CII_OBJECT__VARIABLE *p_variable,CII_OBJECT__ALARM *p_alarm, const CString err_msg);
	//
