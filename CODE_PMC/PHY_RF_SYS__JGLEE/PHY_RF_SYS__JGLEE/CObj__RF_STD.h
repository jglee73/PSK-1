...
private:
	...
	// MON : STABLE ...
	CX__VAR_DIGITAL_CTRL dCH__MON_POWER_CHECK_ACTIVE;
	CX__VAR_DIGITAL_CTRL dCH__MON_POWER_STABLE_ACTIVE;
	CX__VAR_DIGITAL_CTRL dCH__MON_POWER_ABORT_ACTIVE;

	CX__VAR_STRING_CTRL  sCH__MON_POWER_STABLE_MIN;
	CX__VAR_STRING_CTRL  sCH__MON_POWER_STABLE_MAX;

	CX__VAR_STRING_CTRL  sCH__MON_POWER_STABLE_DELAY_TIME;
	CX__VAR_STRING_CTRL  sCH__MON_POWER_STABLE_CHECK_TIME;
	CX__VAR_STRING_CTRL  sCH__MON_POWER_WARNING_CHECK_TIME;

	CX__VAR_STRING_CTRL  sCH__MON_POWER_ABORT_MIN;
	CX__VAR_STRING_CTRL  sCH__MON_POWER_ABORT_MAX;
	CX__VAR_STRING_CTRL  sCH__MON_POWER_ABORT_CHECK_TIME;
	...
	CX__VAR_ANALOG_CTRL  aCH__CFG_POWER_WARNING_BAND;
	CX__VAR_ANALOG_CTRL  aCH__CFG_IDLE_POWER_WARNING_BAND;

	CX__VAR_ANALOG_CTRL  aCH__CFG_POWER_ABORT_BAND;
