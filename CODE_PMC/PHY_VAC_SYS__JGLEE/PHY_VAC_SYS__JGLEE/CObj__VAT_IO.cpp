...
int CObj__VAT_IO::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// MON : STABLE  ...
	{
		str_name = "MON.PRESSURE.CHECK.ACTIVE";
		STD__ADD_DIGITAL(str_name, "OFF ON READY");
		LINK__VAR_DIGITAL_CTRL(dCH__MON_PRESSURE_CHECK_ACTIVE, str_name);

		str_name = "MON.PRESSURE.ABORT.ACTIVE";
		STD__ADD_DIGITAL(str_name, "OFF ON");
		LINK__VAR_DIGITAL_CTRL(dCH__MON_PRESSURE_ABORT_ACTIVE, str_name);

		//
		str_name = "MON.PRESSURE.STABLE.ACTIVE";
		STD__ADD_DIGITAL(str_name, "OFF ON");
		LINK__VAR_DIGITAL_CTRL(dCH__MON_PRESSURE_STABLE_ACTIVE, str_name);

		//
		str_name = "MON.PRESSURE.STABLE.MIN";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_PRESSURE_STABLE_MIN, str_name);

		str_name = "MON.PRESSURE.STABLE.MAX";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_PRESSURE_STABLE_MAX, str_name);

		str_name = "MON.PRESSURE.STABLE.DELAY.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_PRESSURE_STABLE_DELAY_TIME, str_name);

		str_name = "MON.PRESSURE.STABLE.CHECK.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_PRESSURE_STABLE_CHECK_TIME, str_name);

		str_name = "MON.PRESSURE.WARNING.CHECK.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_PRESSURE_WARNING_CHECK_TIME, str_name);

		str_name = "MON.PRESSURE.ABORT.MIN";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_PRESSURE_ABORT_MIN, str_name);

		str_name = "MON.PRESSURE.ABORT.MAX";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_PRESSURE_ABORT_MAX, str_name);

		str_name = "MON.PRESSURE.ABORT.CHECK.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_PRESSURE_ABORT_CHECK_TIME, str_name);
	}
...
int CObj__VAT_IO::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	...
	// ...
	{
		dCH__MON_PRESSURE_CHECK_ACTIVE->Set__DATA(STR__OFF);
		dCH__MON_PRESSURE_STABLE_ACTIVE->Set__DATA(STR__OFF);	
