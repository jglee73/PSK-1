...
private:
	...
	// MON : STABLE ...
	CX__VAR_DIGITAL_CTRL dCH__MON_PRESSURE_CHECK_ACTIVE;
	CX__VAR_DIGITAL_CTRL dCH__MON_PRESSURE_STABLE_ACTIVE;
	CX__VAR_DIGITAL_CTRL dCH__MON_PRESSURE_ABORT_ACTIVE;

	//
	CX__VAR_STRING_CTRL  sCH__MON_PRESSURE_STABLE_MIN;
	CX__VAR_STRING_CTRL  sCH__MON_PRESSURE_STABLE_MAX;

	CX__VAR_STRING_CTRL  sCH__MON_PRESSURE_STABLE_DELAY_TIME;
	CX__VAR_STRING_CTRL  sCH__MON_PRESSURE_STABLE_CHECK_TIME;
	CX__VAR_STRING_CTRL  sCH__MON_PRESSURE_WARNING_CHECK_TIME;

	CX__VAR_STRING_CTRL  sCH__MON_PRESSURE_ABORT_MIN;
	CX__VAR_STRING_CTRL  sCH__MON_PRESSURE_ABORT_MAX;
	CX__VAR_STRING_CTRL  sCH__MON_PRESSURE_ABORT_CHECK_TIME;
	...
	CX__VAR_ANALOG_CTRL   aEXT_CH__VAT__PARA_PRESSURE_TORR;
	CX__VAR_ANALOG_CTRL   aEXT_CH__VAT__PARA_POSITION_PER;

	CX__VAR_ANALOG_CTRL   aEXT_CH__VAT__CUR_PRESSURE_TORR;
	...
	int Fnc__PRESSURE(CII_OBJECT__ALARM *p_alarm, const double set_value);
