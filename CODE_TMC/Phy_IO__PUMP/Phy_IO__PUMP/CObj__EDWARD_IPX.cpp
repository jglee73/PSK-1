...
//--------------------------------------------------------------------------------
CObj__EDWARD_IPX::CObj__EDWARD_IPX()
{
...
//--------------------------------------------------------------------------------
int CObj__EDWARD_IPX::__DEFINE__CONTROL_MODE(obj, l_mode)
{
	sObject_Name = obj;
...
int CObj__EDWARD_IPX::__DEFINE__VERSION_HISTORY(version)
{
	version = "2021.08.17 ...\n";
...
int CObj__EDWARD_IPX::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__EDWARD_IPX::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
//--------------------------------------------------------------------------------
int CObj__EDWARD_IPX::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	CString str_name;
	...
	if(iActive_SIM > 0)
	{
		dEXT_CH__DI_PUMP_WARNING_STS->Set__DATA(STR__OFF);
		dEXT_CH__DI_PUMP_ALARM_STS->Set__DATA(STR__OFF);
		dEXT_CH__DI_PUMP_LEAK_DETECT_STS->Set__DATA(STR__OFF);

		dEXT_CH__DI_PUMP_WATER_FLOW_STS->Set__DATA(STR__ON);
	}
	return 1;
}

//--------------------------------------------------------------------------------
int CObj__EDWARD_IPX::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	int flag = -1;
...
int CObj__EDWARD_IPX::__CALL__MONITORING(id,p_variable,p_alarm)
{
	switch(id)
	{
