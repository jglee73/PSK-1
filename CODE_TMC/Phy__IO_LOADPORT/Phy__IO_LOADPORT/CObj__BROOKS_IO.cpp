...
int CObj__BROOKS_IO::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	...
	// LINK PIO ...
	{
		...
		//
		def_name = "VAR__PIO.FA_MODE";
		p_ext_obj_create->Get__DEF_CONST_DATA(def_name, var_name);
		LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PHY_LPx__PIO_FA_MODE, obj_name,var_name);

		def_name = "VAR__PIO.SERV_REQ";
		p_ext_obj_create->Get__DEF_CONST_DATA(def_name, var_name);
		LINK__EXT_VAR_STRING_CTRL(sEXT_CH__PHY_LPx__PIO_SERV_REQ, obj_name,var_name);

		def_name = "VAR__PIO.MODE";
		p_ext_obj_create->Get__DEF_CONST_DATA(def_name, var_name);
		LINK__EXT_VAR_DIGITAL_CTRL(dEXT_CH__PHY_LPx__PIO_MODE, obj_name,var_name);

		def_name = "VAR__PIO.RUN_SNS";
		p_ext_obj_create->Get__DEF_CONST_DATA(def_name, var_name);
		LINK__EXT_VAR_DIGITAL_CTRL(dEXT_CH__PHY_LPx__PIO_RUN_SNS, obj_name,var_name);

		def_name = "VAR__PIO.TRANSFER_SNS";
		p_ext_obj_create->Get__DEF_CONST_DATA(def_name, var_name);
		LINK__EXT_VAR_DIGITAL_CTRL(dEXT_CH__PHY_LPx__PIO_TRANSFER_SNS, obj_name,var_name);
	}
