...
int CObj__STEP_LLx::APC_OBJ__Start_MODE(const CString& mode_name)
{
	CString log_msg;
	int	nIsBusy = -1;
	int	nRet = -1;
...
int CObj__STEP_LLx::APC_OBJ__Wait_MODE(const CString& log_id)
{
	CString log_msg;
	CString cur_mode;
	int	nRet = -1;
...
int CObj__STEP_LLx::APC_OBJ__Status_MODE(const CString& log_id)
{
	CString log_msg;
	CString cur_mode;
	int	nRet = -1;
...
int CObj__STEP_LLx::APC_OBJ__Call_MODE(const CString& mode_name, const CString& log_id)
{
	CString log_msg;
	int	nIsBusy = -1;
	int	nRet = -1;
...
int CObj__STEP_LLx::APC_OBJ__Abort_Call_MODE(const CString& mode_name, const CString& log_id)
{
	CString log_msg;
	int	nIsBusy = -1;
	int	nRet = -1;
