...
//-------------------------------------------------------------------------
CObj__CHM_TwoManiFold::CObj__CHM_TwoManiFold()
{
...
//-------------------------------------------------------------------------
int CObj__CHM_TwoManiFold::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
...
int CObj__CHM_TwoManiFold::__DEFINE__VERSION_HISTORY(version)
{
...
int CObj__CHM_TwoManiFold::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__CHM_TwoManiFold::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
//-------------------------------------------------------------------------
int CObj__CHM_TwoManiFold::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	CString str_name;
...
//-------------------------------------------------------------------------
int CObj__CHM_TwoManiFold::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	// ...
	{
		CString log_msg;
...
int CObj__CHM_TwoManiFold::__CALL__MONITORING(id,p_variable,p_alarm)
{
	switch(id)
	{
