...
class CObj__TMC_OneManiFold : public __IOBJ__STD_TYPE
{
private:
	...
	CX__VAR_DIGITAL_CTRL dEXT_CH__LBA_PUMPING_STS_FLAG;
	CX__VAR_DIGITAL_CTRL dEXT_CH__LBA_VENTING_STS_FLAG;
	CX__VAR_DIGITAL_CTRL dEXT_CH__LBB_PUMPING_STS_FLAG;
	CX__VAR_DIGITAL_CTRL dEXT_CH__LBB_VENTING_STS_FLAG;
	...
	int  Call__LBA_PUMP(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm);

	// LEAK_CHECK -----
	CString sMODE__LBA_LEAK_CHECK;
	int  Call__LBA_LEAK_CHECK(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm);

	int  Fnc__LBA_LEAK_CHECK(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm);


	// LBB ---------------
	// PUMP -----
	CString sMODE__LBB_PUMP;
	int  Call__LBB_PUMP(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm);

	// LEAK_CHECK -----
	CString sMODE__LBB_LEAK_CHECK;
	int  Call__LBB_LEAK_CHECK(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm);

	int  Fnc__LBB_LEAK_CHECK(CII_OBJECT__VARIABLE* p_variable,CII_OBJECT__ALARM* p_alarm);
