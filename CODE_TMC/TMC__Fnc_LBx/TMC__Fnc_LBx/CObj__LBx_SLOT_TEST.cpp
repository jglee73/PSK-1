...
//-------------------------------------------------------------------------
CObj__LBx_SLOT_TEST::CObj__LBx_SLOT_TEST()
{
...
//-------------------------------------------------------------------------
int CObj__LBx_SLOT_TEST::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
	...
	{
		// SV CYCLE_TEST ...
		ADD__CTRL_VAR(sMODE__LL1_LEFT_SV_CYCLE_TEST,  "LL1_LEFT.SV.CYCLE_TEST" );
		ADD__CTRL_VAR(sMODE__LL1_RIGHT_SV_CYCLE_TEST, "LL1_RIGHT.SV.CYCLE_TEST");

		ADD__CTRL_VAR(sMODE__LL2_LEFT_SV_CYCLE_TEST,  "LL2_LEFT.SV.CYCLE_TEST" );
		ADD__CTRL_VAR(sMODE__LL2_RIGHT_SV_CYCLE_TEST, "LL2_RIGHT.SV.CYCLE_TEST");

		// DV CYCLE_TEST ...
		ADD__CTRL_VAR(sMODE__LL1_LEFT_DV_CYCLE_TEST,  "LL1_LEFT.DV.CYCLE_TEST" );
		ADD__CTRL_VAR(sMODE__LL1_RIGHT_DV_CYCLE_TEST, "LL1_RIGHT.DV.CYCLE_TEST");

		ADD__CTRL_VAR(sMODE__LL2_LEFT_DV_CYCLE_TEST,  "LL2_LEFT.DV.CYCLE_TEST" );
		ADD__CTRL_VAR(sMODE__LL2_RIGHT_DV_CYCLE_TEST, "LL2_RIGHT.DV.CYCLE_TEST");
	}	
	return 1;
}

int CObj__LBx_SLOT_TEST::__DEFINE__VERSION_HISTORY(version)
{
	// ...
	{
...
// ...
int CObj__LBx_SLOT_TEST::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__LBx_SLOT_TEST::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
//-------------------------------------------------------------------------
int CObj__LBx_SLOT_TEST::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	CString str_name;
	...
	// DATA.LLx_SIZE ...
	{
		...
		for(i=0; i<iLLx_SIZE; i++)
		{
			...
			LINK__EXT_VAR_ANALOG_CTRL(aEXT_CH__LLx_FNC__PARA_SLOT_ID[i], obj_name,var_name);
		}
	}
...
//-------------------------------------------------------------------------
int CObj__LBx_SLOT_TEST::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	...
	// ...
	{
		     IF__CTRL_MODE(sMODE__LL1_LEFT_SV_CYCLE_TEST)		flag = Call__LL1_LEFT_SV_CYCLE_TEST(p_variable,  p_alarm);
		ELSE_IF__CTRL_MODE(sMODE__LL1_RIGHT_SV_CYCLE_TEST)		flag = Call__LL1_RIGHT_SV_CYCLE_TEST(p_variable, p_alarm);
		ELSE_IF__CTRL_MODE(sMODE__LL2_LEFT_SV_CYCLE_TEST)		flag = Call__LL2_LEFT_SV_CYCLE_TEST(p_variable,  p_alarm);
		ELSE_IF__CTRL_MODE(sMODE__LL2_RIGHT_SV_CYCLE_TEST)		flag = Call__LL2_RIGHT_SV_CYCLE_TEST(p_variable, p_alarm);

		ELSE_IF__CTRL_MODE(sMODE__LL1_LEFT_DV_CYCLE_TEST)		flag = Call__LL1_LEFT_DV_CYCLE_TEST(p_variable,  p_alarm);
		ELSE_IF__CTRL_MODE(sMODE__LL1_RIGHT_DV_CYCLE_TEST)		flag = Call__LL1_RIGHT_DV_CYCLE_TEST(p_variable, p_alarm);
		ELSE_IF__CTRL_MODE(sMODE__LL2_LEFT_DV_CYCLE_TEST)		flag = Call__LL2_LEFT_DV_CYCLE_TEST(p_variable,  p_alarm);
		ELSE_IF__CTRL_MODE(sMODE__LL2_RIGHT_DV_CYCLE_TEST)		flag = Call__LL2_RIGHT_DV_CYCLE_TEST(p_variable, p_alarm);
	}
...
int CObj__LBx_SLOT_TEST::__CALL__MONITORING(id,p_variable,p_alarm)
{
	// ...
	{
