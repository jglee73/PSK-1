...
// SV CYCLE_TEST ...
int  CObj__LBx_SLOT_TEST::
Call__LL1_LEFT_SV_CYCLE_TEST(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm)
{
	return Fnc__LLx_CYCLE_TEST(p_variable,p_alarm, VLV_TYPE__SV, _LLx_INDEX__LL1, _LLx_SLOT__LEFT);
}
int  CObj__LBx_SLOT_TEST::
Call__LL1_RIGHT_SV_CYCLE_TEST(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm)
{
	return Fnc__LLx_CYCLE_TEST(p_variable,p_alarm, VLV_TYPE__SV, _LLx_INDEX__LL1, _LLx_SLOT__RIGHT);
}

int  CObj__LBx_SLOT_TEST::
Call__LL2_LEFT_SV_CYCLE_TEST(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm)
{
	return Fnc__LLx_CYCLE_TEST(p_variable,p_alarm, VLV_TYPE__SV, _LLx_INDEX__LL2, _LLx_SLOT__LEFT);
}
int  CObj__LBx_SLOT_TEST::
Call__LL2_RIGHT_SV_CYCLE_TEST(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm)
{
	return Fnc__LLx_CYCLE_TEST(p_variable,p_alarm, VLV_TYPE__SV, _LLx_INDEX__LL2, _LLx_SLOT__RIGHT);
}

// DV CYCLE_TEST ...
int  CObj__LBx_SLOT_TEST::
Call__LL1_LEFT_DV_CYCLE_TEST(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm)
{
	return Fnc__LLx_CYCLE_TEST(p_variable,p_alarm, VLV_TYPE__DV, _LLx_INDEX__LL1, _LLx_SLOT__LEFT);
}
int  CObj__LBx_SLOT_TEST::
Call__LL1_RIGHT_DV_CYCLE_TEST(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm)
{
	return Fnc__LLx_CYCLE_TEST(p_variable,p_alarm, VLV_TYPE__DV, _LLx_INDEX__LL1, _LLx_SLOT__RIGHT);
}

int  CObj__LBx_SLOT_TEST::
Call__LL2_LEFT_DV_CYCLE_TEST(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm)
{
	return Fnc__LLx_CYCLE_TEST(p_variable,p_alarm, VLV_TYPE__DV, _LLx_INDEX__LL2, _LLx_SLOT__LEFT);
}
int  CObj__LBx_SLOT_TEST::
Call__LL2_RIGHT_DV_CYCLE_TEST(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm)
{
	return Fnc__LLx_CYCLE_TEST(p_variable,p_alarm, VLV_TYPE__DV, _LLx_INDEX__LL2, _LLx_SLOT__RIGHT);
}


// ...
int  CObj__LBx_SLOT_TEST::
Fnc__LLx_CYCLE_TEST(CII_OBJECT__VARIABLE* p_variable, 
					...
					const int slot_id)
{
	...
	// Parameter ...
	{
		aEXT_CH__LLx_FNC__PARA_SLOT_ID[llx_index]->Set__VALUE(slot_id);
	}
