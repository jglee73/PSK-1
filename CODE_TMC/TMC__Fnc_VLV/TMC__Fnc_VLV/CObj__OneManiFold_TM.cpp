...
//-------------------------------------------------------------------------
CObj__OneManiFold_TM::CObj__OneManiFold_TM()
{
...
//-------------------------------------------------------------------------
int CObj__OneManiFold_TM::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
...
int CObj__OneManiFold_TM::__DEFINE__VERSION_HISTORY(version)
{

	return 1;
}

int CObj__OneManiFold_TM::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__OneManiFold_TM::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
//-------------------------------------------------------------------------
int CObj__OneManiFold_TM::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	CString str_name;
	...
	// I/O OBJ ...
	{
		// PUMP VLV
		{
			def_name = "VAR__IO_DO_TM_SOFT_PUMP_VLV";
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name,def_data);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(def_data, obj_name, var_name);
			LINK__EXT_VAR_DIGITAL_CTRL(doEXT_CH__TMC_CHM__SOFT_PUMP_VLV__SET, obj_name, var_name);
		...
		// VENT VLV
		{
			def_name = "VAR__IO_DO_TM_SOFT_VENT_VLV";
			p_ext_obj_create->Get__DEF_CONST_DATA(def_name,def_data);
			p_ext_obj_create->Get__CHANNEL_To_OBJ_VAR(def_data, obj_name, var_name);
			LINK__EXT_VAR_DIGITAL_CTRL(doEXT_CH__TMC_CHM__SOFT_VENT_VLV__SET, obj_name, var_name);
...
//-------------------------------------------------------------------------
int CObj__OneManiFold_TM::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
...
int CObj__OneManiFold_TM::__CALL__MONITORING(id,p_variable,p_alarm)
{
