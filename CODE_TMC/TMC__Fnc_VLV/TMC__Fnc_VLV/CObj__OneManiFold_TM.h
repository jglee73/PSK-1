...
class CObj__OneManiFold_TM : public __IOBJ__STD_TYPE
{
private:
	...
	// I/O OBJ ...
	CX__VAR_DIGITAL_CTRL doEXT_CH__TMC_CHM__SOFT_PUMP_VLV__SET;
	CX__VAR_DIGITAL_CTRL doEXT_CH__TMC_CHM__FAST_PUMP_VLV__SET;

	CX__VAR_DIGITAL_CTRL doEXT_CH__TMC_CHM__SOFT_VENT_VLV__SET;
	...
	int  Check__TMC_CHM__ALL_VENT_VLV_CLOSE();
