...
//-------------------------------------------------------------------------
CObj__TwoManiFold_LL::CObj__TwoManiFold_LL()
{
...
//-------------------------------------------------------------------------
int CObj__TwoManiFold_LL::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
...
int CObj__TwoManiFold_LL::__DEFINE__VERSION_HISTORY(version)
{

	return 1;
}

int CObj__TwoManiFold_LL::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// ...
	{
		...
		STD__ADD_ANALOG_WITH_X_OPTION(str_name,"sec",3, 0.3,10.0,"");
...
int CObj__TwoManiFold_LL::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
//-------------------------------------------------------------------------
int CObj__TwoManiFold_LL::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	CString str_name;
	...
	// I/O OBJ ...
	{
		...
		{
			// PUMP VLV
			def_name = "VAR__IO_DO_LL1_SOFT_PUMP_VLV";
...
//-------------------------------------------------------------------------
int CObj__TwoManiFold_LL::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
...
int CObj__TwoManiFold_LL::__CALL__MONITORING(id,p_variable,p_alarm)
{
