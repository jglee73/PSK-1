...
//-------------------------------------------------------------------------
CObj__UPPER_ATM_ROBOT::CObj__UPPER_ATM_ROBOT()
{
...
//-------------------------------------------------------------------------
int CObj__UPPER_ATM_ROBOT::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
...
int CObj__UPPER_ATM_ROBOT::__DEFINE__VERSION_HISTORY(version)
{
...
int CObj__UPPER_ATM_ROBOT::__DEFINE__VARIABLE_STD(p_variable)
{
...
int CObj__UPPER_ATM_ROBOT::__DEFINE__ALARM(p_alarm)
{

	return 1;
}

int CObj__UPPER_ATM_ROBOT::__Define__USER_FUNCTION(CII_DEFINE__FUNCTION *p_fnc_ctrl)
{
...
//-------------------------------------------------------------------------
int CObj__UPPER_ATM_ROBOT::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{
	CString def_name;
	CString def_data;
	CString str_name;
	...
	// ATM_ROBOT
	{
		...
		//
		str_name = "OBJ.STATUS";
		LINK__EXT_VAR_DIGITAL_CTRL(xEXT_CH__ATM_ROBOT__OBJ_STATUS, def_data,str_name);

		//
		str_name = "PARA.ARM";
		LINK__EXT_VAR_DIGITAL_CTRL(xEXT_CH__ATM_ROBOT__PARA_ARM, def_data,str_name);

		str_name = "PARA.MODULE";
		LINK__EXT_VAR_DIGITAL_CTRL(xEXT_CH__ATM_ROBOT__PARA_MODULE, def_data,str_name);

		str_name = "PARA.SLOT";
		LINK__EXT_VAR_DIGITAL_CTRL(xEXT_CH__ATM_ROBOT__PARA_SLOT, def_data,str_name);
	}
	...
	// AL1
	{
		...
		str_name = "OBJ.STATUS";
		LINK__EXT_VAR_DIGITAL_CTRL(xEXT_CH__AL1__OBJ_STATUS, def_data,str_name);
	}
	...
	// VISx
	{
		...
		str_name = "OBJ.STATUS";
		LINK__EXT_VAR_DIGITAL_CTRL(xEXT_CH__VIS1__OBJ_STATUS, def_data,str_name);
	}
	*/
...
//-------------------------------------------------------------------------
int CObj__UPPER_ATM_ROBOT::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	CString para_module;
	...
	// ...
	{
		     IF__CTRL_MODE(sMODE__SWAP_ALx)			flag = Call__SWAP_ALx(p_variable);
...
int CObj__UPPER_ATM_ROBOT::__CALL__MONITORING(id,p_variable,p_alarm)
{
