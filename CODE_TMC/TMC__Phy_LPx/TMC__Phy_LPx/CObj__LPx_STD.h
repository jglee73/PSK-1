...
private:
	...
	CX__VAR_STRING_CTRL  sEXT_CH__FA_MODE;
	CX__VAR_STRING_CTRL  sEXT_CH__RFx__FA_MODE;

	//...
	CX__VAR_STRING_CTRL  sEXT_CH__FA_SERVICE_MODE;
	CX__VAR_STRING_CTRL  sEXT_CH__RFx__FA_SERVICE_MODE;
