...
#ifndef  CINTERFACE_GUI_H
#define  CINTERFACE_GUI_H
...
public:
	...
	void Set_DATA(const CString& var_data)
	{
	...
	int  Check_DATA(const CString& cmp_data)
	{
		EnterCriticalSection(&mCS_LOCK);
		...
		if(sVAR_DATA.CompareNoCase(cmp_data) == 0)
		{
			flag = 1;
		}
		//
