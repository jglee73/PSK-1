#ifndef _UI__INTERFACE_HEADER_H_
#define _UI__INTERFACE_HEADER_H_


#pragma comment(lib, "C:\\GES__Application_Interface\\Interface_Header\\UI\\UTILITY\\UI__Interface.lib")
